...
from src.OnlinePaymentFraudDetection.entity.config_entity import ModelEvaluationConfig
from sklearn.metrics import precision_score, recall_score, f1_score, accuracy_score
from src.OnlinePaymentFraudDetection.utils.common import save_json
...
class ModelEvaluation:
    ...
    def log_into_mlflow(self):
        ...
        os.environ["MLFLOW_TRACKING_URI"]='https://dagshub.com/augustin7766/OnlinePaymentsFraudDetection_with_MLflow.mlflow'
        ...
        mlflow.set_experiment('second_exp_02')
